package i5.las2peer.services.musicRes;
...
@ServicePath("music")
@ManualDeployment
public class MusicRes extends RESTService {
  ...
  @SwaggerDefinition(
      info = @Info(title = "3", version = "$Metadata_Version$",
          ...
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg2/microservice-3/blob/master/LICENSE.txt") ) )
  @Path("/")
  public static class RootResource {

    private final MusicRes service = (MusicRes) Context.getCurrent().getService();
